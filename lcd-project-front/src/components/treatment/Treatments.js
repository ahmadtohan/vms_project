...
const Treatments = () => {
  ...
  const onGlobalFilterChange = (e) => {
    ...
    list(0, numOfRows, null, [
      ...
      { field: "patient.fullName", operation: "like", value: "%" + value + "%" },
  ...
  const onRowSelect = (event) => {
    console.log(event);
    navigate("/lcd/app/viewTreatment?id=" + event.data.id);
  };
  ...
  return (
    <div className="card">
      ...
      >
        <Column field="patient.fullName" header="Patient" sortable></Column>
