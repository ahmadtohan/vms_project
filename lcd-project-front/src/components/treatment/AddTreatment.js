...
const AddTreatment = () => {
  ...
  return (
    <div className="card">
      <Toast ref={toast} />
      <Tag severity="success" style={{ marginBottom: '40px' }} value="Add Treatment: "></Tag>
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="flex align-items-center">
          ...
          <Input name="patient" type="autoComplete" field="fullName" value={formik.values["patient"]}
            title="Patient" multiple="false" suggestions={filteredPatients} completeMethod={searchPatient}
            onChange={(e) => { formik.setFieldValue("patient", e.value); }} formik={formik} />
        ...
        <div className="flex align-items-center">
          ...
          <Input name="status" type="dropdown" title="Status" value={formik.values["status"]}
            onChange={(e) => {
              formik.setFieldValue("status", e.value);

            }}
            options={statuses} optionLabel="label" placeholder="Select Status" formik={formik} />
