...
const Test = () => {
    ...
    const footer = (
            <div className="flex flex-wrap justify-content-end gap-2">
                <Button  label="Save" icon="pi pi-check" onClick={confirm1} />
                <Button label="Cancel" icon="pi pi-times" onClick={confirm2} className="p-button-outlined p-button-secondary" />
            </div>
            );
    return (
            <div>
                ...
                <Toast ref={toast} />
                <ConfirmDialog />
                <div  className="card flex flex-wrap gap-2 justify-content-center"> <div className="card flex justify-content-center">
                    ...
                    <div>
                        <Button id="bt1" label="Ok" onClick={handleLogClick} />
                        {visible ? (
                                    <h1>Hello! isLoggedIn</h1>
                                            ) : (
                            <h1>Hello! isNotLoggedIn</h1>
                                    )}
                        <p id="demo"></p>
                    </div>
...
function BasicDemo() {
    ...
    useEffect(() => {
        ProductService.getProducts().then((data) => {setProducts(data); setList(data);});
  ...
  const filterBySearch = (event) => {
    ...
    const header = () => {
        ...
        return (
                <div className="flex justify-content-end">
                    <span className="p-input-icon-left" style={{marginInlineEnd: '13px'}} >
                        <i className="pi pi-search" />
                        <InputText placeholder="Search" onChange={filterBySearch} />
                    </span>
    ...
    return (
            <div className="card">
                <DataView  paginator rows={5} value={products} itemTemplate={itemTemplate}  layout={layout} header={header()} />
            </div>
            )
}
